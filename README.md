<!-- SEO Meta -->
<!--
  Title: Magento 2 Notification Bar Extension with Countdown Timers, Targeting & Scheduling | Hyva + Luma | Panth Infotech
  Description: Panth Notification Bar adds unlimited stackable announcement bars to Magento 2. Run promo bars, flash sale countdown timers, CTA buttons, scheduling, page targeting, customer group targeting, geo-targeting, device rules, and dismissible cookie memory. Native Hyva (Alpine.js) and Luma templates. Works on Magento 2.4.4 to 2.4.8 and PHP 8.1 to 8.4. Built by Top Rated Plus Magento developer Kishan Savaliya.
  Keywords: magento 2 notification bar, magento 2 announcement bar, magento 2 promo bar, magento 2 countdown timer, sticky header bar magento, hyva notification bar, luma notification bar, magento 2 top bar, magento 2 bottom bar, magento 2 flash sale bar, magento 2 free shipping bar, magento 2 geo targeted bar, magento 2 customer group bar, panth notification bar, mage2kishan notification bar, hire magento developer, top rated plus upwork, kishan savaliya magento
  Author: Kishan Savaliya (Panth Infotech)
  Canonical: https://kishansavaliya.com/magento-2-notification-bar.html
-->
...
[![Live Demo & Details](https://img.shields.io/badge/Live%20Demo%20%26%20Details-magento--2--notification--bar-0D9488?style=flat)](https://kishansavaliya.com/magento-2-notification-bar.html)
[![Packagist](https://img.shields.io/badge/Packagist-mage2kishan%2Fmodule--notification--bar-orange?logo=packagist&logoColor=white)](https://packagist.org/packages/mage2kishan/module-notification-bar)
...
1. Download the latest release from [Packagist](https://packagist.org/packages/mage2kishan/module-notification-bar) or from the [product page](https://kishansavaliya.com/magento-2-notification-bar.html).
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://kishansavaliya.com/magento-2-notification-bar.html">
    <img src="https://img.shields.io/badge/View%20Product%20Page-magento--2--notification--bar-0D9488?style=for-the-badge" alt="View Product Page" />
  </a>
</p>
...
| Resource | Link |
|---|---|
| **Product Page** | [magento-2-notification-bar.html](https://kishansavaliya.com/magento-2-notification-bar.html) |
| **Packagist** | [mage2kishan/module-notification-bar](https://packagist.org/packages/mage2kishan/module-notification-bar) |
| **GitHub** | [mage2sk/module-notification-bar](https://github.com/mage2sk/module-notification-bar) |
| **Website** | [kishansavaliya.com](https://kishansavaliya.com) |
...
<p align="center">
  <strong>Ready to add targeted announcement bars to your store?</strong><br/>
  <a href="https://kishansavaliya.com/magento-2-notification-bar.html">
    <img src="https://img.shields.io/badge/%F0%9F%9A%80%20See%20Notification%20Bar%20%E2%86%92-Product%20Page%20%26%20Demo-DC2626?style=for-the-badge" alt="See Notification Bar" />
  </a>
</p>
