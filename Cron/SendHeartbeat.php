<?php
/**
 * Daily heartbeat cron for Panth_NotificationBar. Skips if Panth_Core is
...
namespace Panth\NotificationBar\Cron;

use Magento\Framework\Module\Manager as ModuleManager;
use Panth\NotificationBar\Service\InstallReporter;
