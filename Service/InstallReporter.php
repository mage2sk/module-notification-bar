<?php
/**
 * Standalone install + heartbeat reporter for Panth_NotificationBar.
 *
...
namespace Panth\NotificationBar\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_NotificationBar';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-notification-bar';
